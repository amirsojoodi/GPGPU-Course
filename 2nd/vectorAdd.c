...
void sequential_naive_vectorAdd(node *first, node *second, node *out, int size){
	for(int i = 0; i < size; i++){
		out[i].a = first[i].a + second[i].a;
	}
}

void sequential_vectorAdd_first_optimization(node *first, node *second, node *out, int size){
...
void sequential_vectorAdd_second_optimization(node *first, node *second, node *out, int size){
...
void sequential_vectorAdd_third_optimization(node *first, node *second, node *out, int size){
...
void sequential_vectorAdd_fourth_optimization(node *first, node *second, node *out, int size){
